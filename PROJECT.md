...
- ご支援（寄付）ページ — 2026-09-03に保留(Decision Log 0075)、
  2026-09-10のトップページ再設計に伴いプロジェクトオーナーが解禁を
  決定。詳細はDecision Log 0111参照。
- メルマガ — 2026-09-04に保留(Decision Log 0081)、2026-09-10の
  トップページ再設計に伴いプロジェクトオーナーが解禁を決定。詳細は
  Decision Log 0111参照。
- 研究の本棚 — 2026-09-10のトップページ再設計で新設。詳細はDecision
  Log 0111参照。
